            ...
            collections.map(col => {
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center justify-between p-4 rounded-2xl border transition-all duration-300 text-left cursor-pointer active:scale-[0.98] ${isAdded ? "bg-red-900/40 border-red-500/50 shadow-[0_0_15px_rgba(220,38,38,0.2)]" : "bg-black/40 border-red-900/30 hover:border-red-500/40 hover:bg-[#1a0505]/60 hover:shadow-[0_4px_12px_rgba(220,38,38,0.1)]"
                    }`}
                >
                  <div>
                  ...
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs transition-all duration-300 ${isAdded ? "bg-gradient-to-br from-red-600 to-red-800 text-white shadow-[0_0_10px_rgba(220,38,38,0.6)]" : "bg-black/50 text-gray-400 border border-red-900/30"
                    }`}>
